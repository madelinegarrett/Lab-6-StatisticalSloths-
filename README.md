...
COflights %>% 
  ...
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 0) & (ARR_DELAY <= 252))) %>%
  summarise(DEP_DELAY=n())
...
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 252) & (ARR_DELAY <= 504))) %>%
  summarise(DEP_DELAY=n())
  
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 504) & (ARR_DELAY <= 756))) %>%
  summarise(DEP_DELAY=n())
  
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 756) & (ARR_DELAY <= 1008))) %>%
  summarise(DEP_DELAY=n())
...
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 1008) & (ARR_DELAY <= 1260))) %>%
  summarise(DEP_DELAY=n())
...
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 1260) & (ARR_DELAY <= 1512))) %>%
  summarise(DEP_DELAY=n())
...
COflights %>% 
  filter(!is.na(DEP_DELAY)) %>%
  filter(!is.na(ARR_DELAY)) %>%
  filter((DEP_DELAY > 0) & ((ARR_DELAY > 1512) & (ARR_DELAY <= 1764))) %>%
  summarise(DEP_DELAY=n())
